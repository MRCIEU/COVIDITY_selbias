...
log using "out/log-null-all-extreme.txt", text replace

set seed 1234

tempname memhold
postfile `memhold' str30 outcometype str30 strata estimate lower upper using "out/sim-main-null-all-extreme.dta" , replace
...
*	regress sd_bmi education_alevel education_voc education_degree sex_m sd_age smoking_previous smoking_current sd_tdi
	...
	*gen covidRiskPart = -2*education_alevel + 0.0440*education_voc + -0.2748*education_degree + 0.2557*sex_m + -0.2043*sd_age + 0.0507*smoking_previous -0.1405*smoking_current + 0.1682*sd_tdi + -2.2579) + 3*rnormal(0,1)
