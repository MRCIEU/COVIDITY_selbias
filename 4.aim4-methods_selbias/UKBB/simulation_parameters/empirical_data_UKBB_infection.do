...
do "$scriptDir/4.aim4-methods_selbias/UKBB/simulation_parameters/infection_simulation_parameters.do" "TestsAndDeath" "death" "phase1" "20210423"

* Case definition using test and death data - Phase 2 (post-mass testing)
do "$scriptDir/2.aim4-methods_selbias/UKBB/simulation_parameters/infection_simulation_parameters.do" "TestsAndDeath" "death" "phase1" "20210423"
