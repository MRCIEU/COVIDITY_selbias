...
matrix results = results[1..6,1..12]
	putexcel set 20210409_UKBB_simulations_severity_`sampleDef'.xlsx, sheet(bmi_outcome_all) modify
...
matrix results = r(table)
matrix results = results[1..6,1..12]
	putexcel set 20210409_UKBB_simulations_severity_`sampleDef'.xlsx, sheet(covid_outcome_tested) modify
	putexcel A1 = matrix(results), names nformat(number_d2)
...
matrix results = results[1..6,1..13]
	putexcel set 20210409_UKBB_simulations_severity_`sampleDef'.xlsx, sheet(test_outcome_all) modify
	putexcel A1 = matrix(results), names nformat(number_d2)
...
putexcel set 20210409_UKBB_simulations_severity_`sampleDef', sheet(prevalence_and_distributions) modify
