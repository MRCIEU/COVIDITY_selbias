...
Sub-do file to run univariate analyses between UKBB participant characteristics and having severe COVID-19
...
foreach exposure in sex sd_bmi current_smoke {
 	...
 	putexcel set `date'_multivariate_severity_`exposure'_`sampleDef'_`phase', sheet(`exposure') modify
...
* Association between BMI and COVID-19 death, sequentially adjusting for confounders
...
* Association between sex and COVID-19 death, sequentially adjusting for confounders
...
* Association between smoking and COVID-19 death, sequentially adjusting for confounders
local x=1
